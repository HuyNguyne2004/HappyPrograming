...
public partial class HappyprogrammingContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>().HasData(
            new User { Id = 1, Username = "admin01", Password = "password123", FirstName = "Admin", LastName = "System", Gender = "Other", Dob = new DateOnly(1990, 1, 1), PhoneNumber = "0123456789", EmailAddress = "admin@happy.com", RoleId = 1, Status = "Active", CreatedAt = DateTime.Now },
            new User { Id = 2, Username = "mentor_khoa", Password = "password123", FirstName = "Khoa", LastName = "Nguyen", Gender = "Male", Dob = new DateOnly(1995, 5, 20), PhoneNumber = "0987654321", EmailAddress = "khoa@mentor.com", RoleId = 2, Status = "Active", CreatedAt = DateTime.Now },
            new User { Id = 3, Username = "mentee_an", Password = "password123", FirstName = "An", LastName = "Tran", Gender = "Female", Dob = new DateOnly(2002, 10, 15), PhoneNumber = "0909090909", EmailAddress = "an@mentee.com", RoleId = 3, Status = "Active", CreatedAt = DateTime.Now },
            new User { Id = 4, Username = "mentor_lan", Password = "password123", FirstName = "Lan", LastName = "Hoang", Gender = "Female", Dob = new DateOnly(1992, 3, 10), PhoneNumber = "0911223344", EmailAddress = "lan.hoang@mentor.com", RoleId = 2, Status = "Active", CreatedAt = DateTime.Now },
            new User { Id = 5, Username = "mentor_minh", Password = "password123", FirstName = "Minh", LastName = "Vu", Gender = "Male", Dob = new DateOnly(1988, 8, 25), PhoneNumber = "0922334455", EmailAddress = "minh.vu@mentor.com", RoleId = 2, Status = "Active", CreatedAt = DateTime.Now },
            new User { Id = 6, Username = "mentee_long", Password = "password123", FirstName = "Long", LastName = "Phi", Gender = "Male", Dob = new DateOnly(2003, 1, 12), PhoneNumber = "0933445566", EmailAddress = "long.phi@mentee.com", RoleId = 3, Status = "Active", CreatedAt = DateTime.Now },
            new User { Id = 7, Username = "mentee_vy", Password = "password123", FirstName = "Vy", LastName = "Le", Gender = "Female", Dob = new DateOnly(2004, 11, 30), PhoneNumber = "0944556677", EmailAddress = "vy.le@mentee.com", RoleId = 3, Status = "Active", CreatedAt = DateTime.Now }
        );
